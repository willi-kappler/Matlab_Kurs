...
\title{\input{../common/title.txt}\\{\scriptsize 3. Matrizen}}
  ...
  \input{../common/title.tex}
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                \item Erzeuge Vektoren der regelmäßigen x- und y-Werte: \matlabInput{xvec = [-2:1:2]; yvec = [-1:1:1];}
            ...
            \end{itemize}
            \item Jetzt \textit{elementweise} Berechnung: \matlabInput{Z = X.*Y;}
        \end{enumerate}
    \end{frame}
