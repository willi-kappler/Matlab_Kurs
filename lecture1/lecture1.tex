...
\begin{document}
    ...
    \begin{frame}
      ...
      \begin{itemize}
        ...
        \begin{itemize}
          \itemsep0.3cm
          \item \matlabInput{doc <Befehlsname>} (Info in einem extra Fenster)
          \item \matlabInput{help <Befehlsname>} (Info im Befehlsfenster)
        \end{itemize}
        ...
        \begin{itemize}
          \itemsep0.3cm
          \item \matlabInput{help sin}
          \item \matlabInput{help exp}
          \item \matlabInput{doc plot}
        \end{itemize}
      \end{itemize}
    \end{frame}
    ...
    \begin{frame}
      ...
      \begin{itemize}
        \item \matlabInput{who}: gibt eine Liste der Variablen im Arbeitsspeicher aus
        \item \matlabInput{whos}: gibt zusätzliche Information (Typ, Größe, Speicherbedarf)
        \item \matlabInput{clear <Variable>}: löscht die Variable
        \item \matlabInput{clear all}: löscht alle Variablen
        \item \matlabInput{clc}: löscht den Inhalt des Befehlsfensters
      \end{itemize}
    \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item Z.B. die Wurzelfunktion (square root): \matlabInput{a = sqrt(2)/2}
      \item Nähere Informationen zur Funktion \matlabInput{sqrt} erhält man mit \matlabInput{help sqrt}.
...
\begin{frame}
  \frameMexercise
  \begin{exercise}
      Erzeugen Sie einen Vektor \matlabInput{y}, der die Funktionswerte des natürlichen Logarithmus an den Stellen
      \matlabInput{x = 1,3,5,7,9} enthält. \\ \\

      Was gibt Matlab aus, wenn Sie \matlabInput{y(1)} eingeben?
  \end{exercise}
\end{frame}
...
\begin{frame}
  \frameMexercise
  \begin{exercise}
      Geben Sie die Vektoren \matlabInput{a} und \matlabInput{b} mit den Elementen \\
      \matlabInput{–10,-8,-6,...,6,8,10} bzw. \matlabInput{10,9,8,...0} mit kurzen Anweisungen ein.
      \alert{Tipp}: \matlabInput{help colon} \\ \\

      Sei \matlabInput{x = [1 3 -2 6 0 7 11 -8 -5]}. Finden Sie mit \\
      \matlabInput{help paren} und \matlabInput{help colon} heraus, wie man aus \matlabInput{x} einen Vektor bildet, der

      \begin{itemize}
          \item das 1., 4. und 9. Element von \matlabInput{x} enthält
          \item aus den ersten 4 Elementen von \matlabInput{x} besteht
          \item jedes zweite Element von \matlabInput{x} enthält.
      \end{itemize}
  \end{exercise}
\end{frame}
