...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
          ...
          \begin{itemize}
            ...
            \item \urlLink{https://www.gnu.org/software/octave/}{GNU Octave } (Open Source, aber nicht 100\% compatibel)
          \end{itemize}
    ...
    \begin{frame}
      ...
      \begin{itemize}
        ...
        \item Variablen haben einen bestimmten \textbf{Typ}, z.B. Ganzzahl, Fließ-kommazahl, Vector, Matrix, ...
      \end{itemize}
    \end{frame}
    ...
    \begin{frame}
      ...
      \begin{exercise}
          \sloppy
          Sie möchten einen Vektor \matlabInput{x} mit den Elementen \matlabInput{0, 0.2$\pi$, 0.4$\pi$ ...,10$\pi$} definieren.
          Dazu können Sie zum Beispiel die elementweise Multiplikation mit \matlabInput{$\pi$} verwenden. Welche Möglichkeiten gibt es? \\ \\

          Wie würde Matlab die Anweisung \matlabInput{y = [0:0.2:10*pi]} interpretieren?
      \end{exercise}
    \end{frame}
