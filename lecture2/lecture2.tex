  ...
  \input{../common/title.tex}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Bsp.: Ihr Programm heißt \texttt{MeinScript.m} und befindet sich im Verzeichnis \directory{MyDocuments / ich / Matlab}.
      ...
      \begin{frame}
          ...
          \begin{itemize}
              ...
              \item \matlabInput{\matlabLink{plot}(x,y)} erzeugt ein Grafikfenster (\texttt{``figure''}), in dem die \texttt{y}-Werte gegen \texttt{x} aufgetragen sind.
      ...
      \begin{frame}
          ...
          \begin{itemize}
              \item Variante 1: mehrere Parameterpaare übergeben: \matlabInput{\matlabLink{plot}(t1,c1,'r-',t2,c2,'b:')}
              \item Variante 2: mit \matlabInput{\matlabLink{hold} on} in Hinzufügmodus wechseln (und mit \matlabInput{\matlabLink{hold} off} wieder verlassen):
              \begin{itemize}
      ...
      \begin{frame}
          ...
          \begin{itemize}
              ...
              \item \matlabInput{\matlabLink{set}(\matlabLink{gcf}, 'paperunits', 'centimeters',} \matlabInput{'paperposition', [1 1 9 6])}
